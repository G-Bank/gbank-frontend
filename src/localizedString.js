...
export const strings = new LocalizedStrings({
  en: {
    ...
    currentAuthLevel: 'Current Auth Level',
    nextAuthLevel: 'Next Auth Level',
    ...
    receiverInfo: 'Receiver phone number or card',
  ...
  fa: {
    ...
    currentAuthLevel: 'سطح کاربری کنونی',
    nextAuthLevel: 'سطح کاربری بعدی',
    ...
    receiverInfo: 'شناسه، شبا، شماره کارت، شماره موبایل',
    description: 'توضیحات',
